<!-- agentquilt: generated file — do not edit. version=sha256-7dcaf4cd9532c4985b570a37eb59bef56b703c10dbfa80f1f1318c05d451fd4b · source: .agentquilt/agents/ · regenerate: agentquilt build -->
...
This file is generated by AgentQuilt itself from fragments under `.agentquilt/agents/project/`. Do not edit `AGENTS.md` or `CLAUDE.md` directly — edit the fragments and run `agentquilt build`.
...
**Current Status**: package manifest v0.1.2, with the next release prepared through Changesets. Core compiler, Zod schemas, and adapters are implemented. CLI binary is `agentquilt`. See the [agentquilt-v1-spec.md](.docs/agentquilt-v1-spec.md) and [v1.1-addendum.md](.docs/agentquilt-v1.1-addendum.md) for the authoritative reference.
